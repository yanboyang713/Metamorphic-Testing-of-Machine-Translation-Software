...
def main():
    ...
    #validation the google sheet,if any cell is empty then set the whole row empty
    ...
    if askValidateGoogleSheet == 'Y':
        ...
        for file_rows in range(1,1001):
            valid_flag=True
            for file_columns in range (1,10):
                if file_google_sheet.cell(row=file_rows,column=file_columns).value is None:
                    valid_flag=False
            if valid_flag == False:
    ...
    #validation the bing sheet,if any cell is empty then set the whole row empty
    ...
    if askValidateBingSheet == 'Y':
        ...
        for file_rows in range(1,1001):
            valid_flag=True
            for file_columns in range (1,10):
                if file_bing_sheet.cell(row=file_rows,column=file_columns).value is None:
                    valid_flag=False
            if valid_flag == False:
                for file_columns_2 in range(1, 10):
    ...
    #validation the youdao sheet,if any cell is empty then set the whole row empty
    ...
    if askValidateYoudaoSheet == 'Y':
        ...
        for file_rows in range(1,1001):
            valid_flag=True
            for file_columns in range (1,10):
                if file_youdao_sheet.cell(row=file_rows,column=file_columns).value is None:
                    valid_flag=False
            if valid_flag == False:
                for file_columns_2 in range(1, 10):
